...
// view, which is owned by postgres and so bypasses ts_profiles' per-row RLS while
// exposing only a generated Learner alias and aggregate leaderboard stats. The
// view is granted to `anon`, so the project's anon key (already public, shipped
// in the web client) is enough — no service-role key required.
//
